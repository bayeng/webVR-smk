...
@section('container')
    <div class="flex min-h-full flex-col justify-center pt-24 sm:px-6 lg:px-8 bg-[#2B2B2B]">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            <img class="mx-auto h-20 w-auto" src="img/logo-vr.png" alt="VR Lab">
            <h2 class="text-center text-2xl font-bold tracking-tight text-white">Sign in to your account
            </h2>
        </div>

        <div class="mt-5 sm:mx-auto sm:w-full sm:max-w-[480px]">
            <div class="bg-gray-600 px-6 py-12 shadow sm:rounded-lg sm:px-12">
